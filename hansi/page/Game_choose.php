...
<body>
  ...
  <div id="wrap">
    ...
    <section class="section">
      ...
      <nav class=menumain>
        <div id="game">
          <a href="ballgame.php"><img src="/media/1.png" width="330" height="250" alt="공피하기게임"></a>
          <div id="gametitle">공피하기 게임</div>
        </div>
        <div id="game">
          <a href="balloongame.php"><img src="/media/2.png" width="330" height="250" alt="풍선터트리기게임"></a>
          <div id="gametitle">풍선터트리기 게임</div>
        </div>
      </div>
    </section>
