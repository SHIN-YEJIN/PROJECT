...
<body>
  ...
  <div id="wrap">
    ...
    <section class="section">
      ...
      <nav class=menumain>
				<div id="board">
					<a href="board1.php"><img src="/media/2.png" width="330" height="250" alt="자유게시판"></a>
					<div id="boardtitle">자유게시판</div>
				</div>
				<div id="board">
					<a href="board2.php"><img src="/media/2.png" width="330" height="250" alt="익명게시판"></a>
					<div id="boardtitle">익명게시판</div>
					<div id="board">
						<a href="text.php"><img src="/media/1.png" width="330" height="250" alt="메일발송"></a>
						<div id="boardtitle">메일발송</div>
					</div>
				</div>
			</div>
